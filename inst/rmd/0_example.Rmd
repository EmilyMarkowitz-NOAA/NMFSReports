...
nickname <- "example" # this is so you can refer to it later systematically
...
Here in figure `r as.numeric(list.filter(plot_list, "example" %in% nickname)[[1]]$number)`, we see that...
...
Here in table `r as.numeric(list.filter(table_list, "example" %in% nickname)[[1]]$number)`, we see that...
