...
Here in table `r ref_listobject(list_obj = list_table, nickname = "example1", sublist = "number")`, we see that...
...
Here in table `r ref_listobject(list_obj = list_table, nickname = "example_foot", sublist = "number")`, we see that...
