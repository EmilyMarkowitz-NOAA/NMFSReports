...
Here in plot `r ref_listobject(list_obj = list_figure, nickname = "example_plot", sublist = "number")`, we see that...
...
Here in figure `r ref_listobject(list_obj = list_figure, nickname = "noaalogo", sublist = "number")`, we see the NOAA logo. 
