...
Here in figure `r crossref(list_obj = list_figures, nickname = "noaalogo", sublist = "number")`, we see the NOAA logo. You can also use \@ref(noaalogo) to reference images. 
