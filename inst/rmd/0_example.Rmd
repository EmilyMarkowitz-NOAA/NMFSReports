...
Remember the pythagorean theorem from before? That was Equation #`r ref_listobject(list_obj = list_equations, nickname = "pythagorean", sublist = "number")` and it had a footnote that said "`r ref_listobject(list_obj = list_equations, nickname = "pythagorean", sublist = "footnote")`".
...
Here in plot `r ref_listobject(list_obj = list_figures, nickname = "example_plot", sublist = "number")`, we see that...
...
Here in figure `r ref_listobject(list_obj = list_figures, nickname = "noaalogo", sublist = "number")`, we see the NOAA logo. 
...
Here in table `r ref_listobject(list_obj = list_tables, nickname = "example1", sublist = "number")`, we see that...
...
Here in table `r ref_listobject(list_obj = list_tables, nickname = "example_foot", sublist = "number")`, we see that...
