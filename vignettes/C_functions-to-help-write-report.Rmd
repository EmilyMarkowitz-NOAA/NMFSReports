...
# 3: The vignette title specified in \VignetteIndexEntry{} is different from the title in the YAML metadata. The former is "C_functions-to-help-write-report", and the latter is "Functions in Action to Help You Write Your Report". If that is intentional, you may set options(rmarkdown.html_vignette.check_title = FALSE) to suppress this check. 
