...
This file is essentially the example file included in the `buidTM()` function. 
...
There are a lot of ways to cite within your report, so here is an example of two: [@RN170] and @RN621. Checkout https://github.com/cboettig/knitcitations for more info!
